...
void IntensityToEdgeoffset_float(float Intensity, out float Edgeoffset)
{
	if (Intensity <= 0.12f) //lower values break
	{
		Edgeoffset = 1;
	}
	else
	{
		Edgeoffset = (1.0f / sqrt(Intensity)) - 1.0f;
	}
}